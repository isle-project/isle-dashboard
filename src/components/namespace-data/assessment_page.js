	...
	return (
		<Fragment>
			...
			<Routes>
				...
				/>
				<Route path="metrics" element={<MetricsPage lessons={props.lessons} namespace={props.namespace} />}
				/>
				<Route path="extensions" element={<ExtensionsPage lessons={props.lessons} namespace={props.namespace} cohorts={props.namespace.cohorts} />} />
			</Routes>
		</Fragment>
	);
};
